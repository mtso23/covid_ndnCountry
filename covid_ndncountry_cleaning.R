...
#load ICT data
ndncntry_covid = read.csv("C:/Users/MariahTso/Desktop/UCLA/aisc_covid/ICT_downloads/ICT_720_639pm_pst.csv") #read csv file
...
urlfile="https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_daily_reports_us/07-14-2020.csv" #update date in file name
